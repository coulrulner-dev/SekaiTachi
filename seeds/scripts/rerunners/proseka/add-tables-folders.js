...
const PREFIX = "Level ";
const TITLE = "Project Sekai: Colorful Stage! feat. Hatsune Miku";
const SHORTTITLE = "pjsk"; // this is used in the tableID
const DESCRIPTION = "All songs in Project Sekai: Colorful Stage";
const LEVELS = [
	"1",
	"2",
	"3",
